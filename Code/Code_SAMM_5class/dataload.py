...
apex_parsing_map_data_path = '../../Dataset/SAMM/SAMM_apex_seg_prob_map_augment'
OF_data_path = '../../Dataset/SAMM/SAMM_onset_apex_OF_augment'
OS_data_path = '../../Dataset/SAMM/SAMM_onset_apex_OS_augment'
    ...
    def __init__(self, split, leave_out, transform=None):
        ...
        if self.split == 'Training':
            ...
            for i in range(14, rowNum):
                ...
                if rows[9] == 'Anger' or rows[9] == 'Contempt' or rows[9] == 'Happiness' or rows[9] == 'Surprise' or rows[9] == 'Other':
                    if rows[0] != leave_out:
                        apex_parsing_map_file_path = os.path.join(apex_parsing_map_data_path, rows[0], rows[1])
                        OF_file_path = os.path.join(OF_data_path, rows[0], rows[1])
                        OS_file_path = os.path.join(OS_data_path, rows[0], rows[1])
