...
model_dir = '../../Model_parameters/SMIC_3class/net/'
all_sub_list = ['s1', 's2', 's3', 's4', 's5', 's6', 's8', 's9', 's11', 's12', 's13', 's14', 's15', 's18', 's19', 's20']
...
print(cm)
#############################
f1_score, precision, recall = fpr(cm, n_exp=3)
print('f1_score:', f1_score, 'precision:', precision, 'recall:', recall)
WAR = weighted_average_recall(cm, n_exp=3, class_num_list=[70, 51, 43])
UAR = unweighted_average_recall(cm, n_exp=3)

plot_Matrix(cm, classes=3, title=None, cmap=plt.cm.Blues)
